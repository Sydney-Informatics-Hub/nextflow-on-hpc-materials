...
singularity pull ${SINGULARITY_CACHEDIR}/fastqc.sif docker://quay.io/biocontainers/fastqc:0.12.1--hdfd78af_0
...
singularity pull ${SINGULARITY_CACHEDIR}/bcftools.sif docker://quay.io/biocontainers/bcftools:1.22--h3a4d415_1
singularity pull ${SINGULARITY_CACHEDIR}/fastp.sif docker://quay.io/biocontainers/fastp:1.0.1--heae3180_0
singularity pull ${SINGULARITY_CACHEDIR}/gatk4.sif docker://quay.io/biocontainers/gatk4:4.6.2.0--py310hdfd78af_1
singularity pull ${SINGULARITY_CACHEDIR}/mulled.sif docker://quay.io/biocontainers/mulled-v2-fe8faa35dbf6dc65a0f7f5d4ea12e31a79f73e40:1bd8542a8a0b42e0981337910954371d0230828e-0
singularity pull ${SINGULARITY_CACHEDIR}/multiqc.sif docker://quay.io/biocontainers/multiqc:1.19--pyhdfd78af_0
